                        ...
                        <div class="col-md-8">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <span class="info-label">친절</span> 
                                    <span class="info-value"><label>고객응대평가</label>
				<input type="range" id="kind" name="kind" min="0" max="5" step="1"></span>
                                </li>
                                <li class="list-group-item">
                                    <span class="info-label">설명</span> 
                                    <span class="info-value"><label>진료
					전 치료 및 가격 설명 평가</label> <input type="range" id="explain" name="explain" min="0" max="5"
					step="1"></span>
                                  </li>
                                <li class="list-group-item">
                                    <span class="info-label">진료</span> 
					...
					type="range" id="facilities" name="facilities" min="0" max="5" step="1"></span>
                                </li>
                                <li class="list-group-item">
					...
					type="range" id="price" name="price" min="0" max="5" step="1"></span>
                                ...
                                <li class="list-group-item">
                                    ...
                                    <span class="info-value"><textarea id="content" name="content" maxlength="500" cols="50" rows="10"></textarea></span>
                                </li>
                            </ul>
                            <div class="mt-3">
