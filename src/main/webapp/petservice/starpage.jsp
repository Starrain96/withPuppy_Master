...
<body>
	<div class="review-form">
		...
		<div class="form-group">
			...
			<input type="range" id="customer-service-rating"
				name="treatment-explanation-rating" min="0" max="5" step="1">
		</div>
		<div class="form-group">
			<label for="treatment-explanation-rating">설명</label> <label>진료
				전 치료 및 가격 설명 평가</label> <input type="range"
				id="treatment-explanation-rating"
				name="treatment-explanation-rating" min="0" max="5" step="1">
		</div>
		<div class="form-group">
			<label for="treatment-rating">진료</label> <label>치료 후 완쾌 수준</label> <input
				type="range" id="treatment-rating" name="treatment-rating" min="0"
				max="5" step="1">
		</div>
		<div class="form-group">
			<label for="facility-rating">시설</label> <label>시설 및 장비 수준</label> <input
				type="range" id="facility-rating" name="facility-rating" min="0"
				max="5" step="1">
		</div>
		<div class="form-group">
			<label for="price-rating">가격</label> <label>진료비 수준</label> <input
				type="range" id="price-rating" name="price-rating" min="0" max="5"
				step="1">
		</div>
	</div>
	...
	<div class="review-form">
		<h2>리뷰 내용</h2>
		<textarea id="review-content" name="review-content" maxlength="500" placeholder="최대 500자까지 입력가능합니다."></textarea>
	</div>
