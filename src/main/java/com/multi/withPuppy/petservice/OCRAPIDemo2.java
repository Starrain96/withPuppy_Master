...
public class OCRAPIDemo2 {
	...
	public static void main(String[] args) {
		...
		String secretKey = "eG5FdndEa25tQUNTb3BDSEpYRlFGUkFIZHNpaUlDa0E=";
		...
		try {
			...
			FileInputStream inputStream = new FileInputStream("treatmentfee01.jpg");
